...
namespace SimpleJson.Tests.DataContractTests
{
#if NUNIT
    ...
    public class PrivateFieldsSerializeTests
    {
        ...
        {
            var result = SimpleJson.SerializeObject(_dataContractPrivateFields, SimpleJson.DataContractJsonSerializerStrategy);
